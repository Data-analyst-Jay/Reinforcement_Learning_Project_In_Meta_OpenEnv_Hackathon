...
class SmartIrrigationEnv(
    ...
    def _parse_result(
        ...
        observation = SmartIrrigationObservation(
            ...
            crop_stress_accumulation=obs_data.get("crop_stress_accumulation", 0.0),
            water_remaining=obs_data.get("water_remaining"),
            crop_component=obs_data.get("crop_component", 0.0),
            decision_component=obs_data.get("decision_component", 0.0),
            total_reward=obs_data.get("total_reward", payload.get("reward", 0.0)),
    ...
    def _parse_state(self, payload: Dict[str, Any]) -> SmartIrrigationState:
        ...
        return SmartIrrigationState(
            ...
            crop_stress_accumulation=payload.get("crop_stress_accumulation", 0.0),
            ...
            last_crop_component=payload.get("last_crop_component", 0.0),
            last_decision_component=payload.get("last_decision_component", 0.0),
            last_total_reward=payload.get("last_total_reward", 0.0),
